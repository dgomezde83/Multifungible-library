...
TEST(TransactionFactory, createESDTIssue)
{
    ...
    tx = txFactory
            ...
            .withOptions(7)
            .buildSigned(pem.getSeed());
    EXPECT_EQ(tx, createTransaction(5, BigUInt(ESDT_ISSUANCE_VALUE), sender, expectedReceiver, gasPrice, 60000000, "issue@416c696365@414c43@03e8@0a@63616e467265657a65@66616c7365@63616e57697065@66616c7365@63616e5061757365@66616c7365@63616e4368616e67654f776e6572@74727565@63616e55706772616465@66616c7365@63616e4164645370656369616c526f6c6573@74727565", "b0ffd1755226e961b2d3105bddc94b1f3ec0a8afbf8d1a55f2872ac3d3c759bb796cc320b7d6e1e603dbc42520aa9fd4fa5120034ef41c2aa18843ae631cd106", cfg.chainId, 6, 7));
    EXPECT_TRUE(tx.verify());
}
