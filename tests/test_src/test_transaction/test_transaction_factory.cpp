...
TEST(TransactionFactory, createESDTIssue)
{
    ...
    tx = txFactory
            ...
            .withOptions(7)
            .buildSigned(pem.getSeed());
    EXPECT_EQ(tx, createTransaction(5, BigUInt(ESDT_ISSUANCE_VALUE), sender, expectedReceiver, gasPrice, 60000000, "issue@416c696365@414c43@03e8@0a@63616e467265657a65@66616c7365@63616e57697065@66616c7365@63616e5061757365@66616c7365@63616e4368616e67654f776e6572@74727565@63616e55706772616465@66616c7365@63616e4164645370656369616c526f6c6573@74727565", "eb689a5831471b476468ab2598053cde9c7ebb690e1dfe3d6fa87de2f387bee87828dcee3f8acc67d090ba35a16397a5a958e4114eb546f20c52d5728cb0b500", cfg.chainId, 6, 7));
    EXPECT_TRUE(tx.verify());
}
