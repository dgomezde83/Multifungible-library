...
#define MULTIFUNGIBLE_ADDQUANTITY_SUCCESSFUL(x) std::string("Emitted ") + std::to_string(x) + std::string(" token") + std::string(( x > 1 ) ? "s" : "" ) + std::string(" successfully")
#define MULTIFUNGIBLE_BURNQUANTITY_SUCCESSFUL(x) std::string("Burned ") + std::to_string(x) + std::string(" token") + std::string(( x > 1 ) ? "s" : "" ) + std::string(" successfully")
...
#define MULTIFUNGIBLE_SFTTRANSACTION_SUCCESSFUL(w,x,y,z) std::string("Sent ") + std::to_string(w) + std::string(( w > 1 ) ? " units of " : " unit of " ) + std::string(x) + std::string("-") + std::to_string(y) + std::string(" to ") + std::string(z) + std::string(" successfully")
#define MULTIFUNGIBLE_EGLDTRANSACTION_SUCCESSFUL(x) std::string("Sent ") + std::to_string(x) + std::string(( x != 1 ) ? " units of " : " unit of " ) + std::string("EGLD successfully")
...
class Multifungible
{
    public:
        ...
        static returnCodeAndChar addSFTQuantity(const char * p_walletName, const char * p_password, const char * p_tokenID, const int p_quantity);
        static returnCodeAndChar burnSFTQuantity(const char * p_walletName, const char * p_password,const char * p_tokenID, const int p_quantity);
        ...
        static returnCodeAndChar SFTTransaction(const char * p_walletName, const char * p_password,const char * p_destinationAddress,const char * p_tokenID, const int p_amount);
        static returnCodeAndChar EGLDTransaction(const char * p_walletName, const char * p_password,const char * p_strAddress, const int p_amount);
